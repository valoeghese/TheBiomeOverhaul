...
public class FirTreeFeature extends OldMegaTreeFeature<DefaultFeatureConfig>
{
	private static final BlockState LOG, LEAVES;

	public FirTreeFeature(Function<Dynamic<?>, ? extends DefaultFeatureConfig> function_1)
	{
