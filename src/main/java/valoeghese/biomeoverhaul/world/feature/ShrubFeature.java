...
public class ShrubFeature extends TBOTreeFeature<DefaultFeatureConfig> implements PublicWorldModifierTester
{
	...
	public boolean generate(Set<BlockPos> set_1, ModifiableTestableWorld world, Random rand, BlockPos blockPos_1, BlockBox mibb)
	{
		int height = 3;
