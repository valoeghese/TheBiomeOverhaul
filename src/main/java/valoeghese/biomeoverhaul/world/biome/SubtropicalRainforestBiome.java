...
public class SubtropicalRainforestBiome extends TBOBiome
{
	...
	{
		super(BiomeFactory.create(0.14F, 0.26F, Category.FOREST).setSurfaceBuilder(SurfaceBuilder.GIANT_TREE_TAIGA).setTemperatureDownfall(0.7F, 0.99F).setSpawnChance(0.23F));
