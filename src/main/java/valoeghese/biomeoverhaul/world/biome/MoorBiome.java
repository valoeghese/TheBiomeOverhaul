...
public class MoorBiome extends TBOBiome
{
	public MoorBiome()
	{
		super(BiomeFactory.create(2.4F, 0.33F, Biome.Category.SWAMP).setTemperatureDownfall(0.4F, 0.4F).setDarkWaterProperties());
