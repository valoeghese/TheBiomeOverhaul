...
public class RainforestMountainsBiome extends TBOBiome
{
	...
	{
		super(BiomeFactory.create(0.8F, 0.4F, Category.JUNGLE).setSurfaceBuilder(CustomSurfaceBuilders.RAINFOREST_BUILDER).setTemperatureDownfall(0.9F, 0.99F).setSpawnChance(0.23F).setBaseBiome("tbo:rainforest"));
