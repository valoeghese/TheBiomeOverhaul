...
public class PeatBogBiome extends TBOBiome {
	public PeatBogBiome() {
		...
		this.theBiomePopulator.addTreeFeature(TBOFeatures.LARGE_SHRUB, FeatureConfig.DEFAULT, 0.7F);
		this.theBiomePopulator.addTreeFeature(TBOFeatures.DEAD_TREE_FEATURE, FeatureConfig.DEFAULT, 1);
