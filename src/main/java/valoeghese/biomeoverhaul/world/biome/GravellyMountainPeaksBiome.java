...
public class GravellyMountainPeaksBiome extends TBOBiome
{

	public GravellyMountainPeaksBiome()
	{
		super(BiomeFactory.create(2.65F, 0.45F, Biome.Category.EXTREME_HILLS).setSurfaceBuilder(SurfaceBuilder.GRAVELLY_MOUNTAIN).setTemperatureDownfall(0.2F, 0.4F).setSpawnChance(0.04F).setBaseBiome("mountains"));
