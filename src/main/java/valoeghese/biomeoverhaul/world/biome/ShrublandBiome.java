...
public class ShrublandBiome extends TBOBiome
{
	
	public ShrublandBiome()
	{
		super(BiomeFactory.create(0.1F, 0.06F, Biome.Category.PLAINS).setTemperatureDownfall(0.65F, 0.45F));
		...
		this.addSpawn(EntityCategory.CREATURE, new Biome.SpawnEntry(EntityType.HORSE, 3, 2, 6));
